...
"use strict";function executePageFunctions(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],n=document.body;e?pageFunctions.common.finalize():pageFunctions.common.init();var t=!0,i=!1,o=void 0;try{for(var a,r=n.classList[Symbol.iterator]();!(t=(a=r.next()).done);t=!0){var l=a.value;l=l.replace(/-/g,"_"),e?"undefined"!=typeof pageFunctions[l]&&"undefined"!=typeof pageFunctions[l].finalize&&pageFunctions[l].finalize():"undefined"!=typeof pageFunctions[l]&&"undefined"!=typeof pageFunctions[l].init&&pageFunctions[l].init()}}catch(c){i=!0,o=c}finally{try{!t&&r["return"]&&r["return"]()}finally{if(i)throw o}}}function normalizeElementHeights(e){var n=document.body.querySelectorAll(e),t=0;if(n){var i=!0,o=!1,a=void 0;try{for(var r,l=n[Symbol.iterator]();!(i=(r=l.next()).done);i=!0){var c=r.value;c.style.minHeight=0,t=c.offsetHeight>t?c.offsetHeight:t}}catch(s){o=!0,a=s}finally{try{!i&&l["return"]&&l["return"]()}finally{if(o)throw a}}var u=!0,_=!1,d=void 0;try{for(var f,v=n[Symbol.iterator]();!(u=(f=v.next()).done);u=!0){var g=f.value;g.style.minHeight=t+"px"}}catch(s){_=!0,d=s}finally{try{!u&&v["return"]&&v["return"]()}finally{if(_)throw d}}}}var pageFunctions={common:{init:function(){},finalize:function(){objectFitVideos(),console.log("fitting wideos"),normalizeElementHeights(".vertical-cards__section__content")}}};document.addEventListener("DOMContentLoaded",function(){executePageFunctions(!0)}),executePageFunctions(),$(document).ready(function(){$(".carousel__content").slick({infinite:!0,slidesToShow:2,slidesToScroll:1,prevArrow:'<button type="button" class="slick-prev"></button>',nextArrow:'<button type="button" class="slick-next"></button>',responsive:[{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:1,infinite:!0}}]})}),$(".header__navigation__mobile-link").click(function(){$(".header__navigation").toggleClass("--active"),$(".header__navigation__mobile-menu-icon__bar").toggleClass("--open")}),$(".header__navigation__menu__item__link").focus(function(){$(".header__navigation").addClass("--active"),$(".header__navigation__mobile-menu-icon__bar").addClass("--open")}),$(".header__navigation__menu__item__link").blur(function(){$(".header__navigation").removeClass("--active"),$(".header__navigation__mobile-menu-icon__bar").removeClass("--open")}),$(document).ready(function(){$("a").on("click",function(e){if(""!==this.hash){e.preventDefault();var n=this.hash;$("html, body").animate({scrollTop:$(n).offset().top},800,function(){window.location.hash=n})}})});