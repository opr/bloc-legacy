...
var _TestModule = __webpack_require__(17);
...
if (elements.test) {
    anchors.test = { container: elements.test, component: _react2.default.createElement(_TestModule2.default, null) };
}
...
for (var i in anchors) {
    ...
    if (anchors[i]) {
        (0, _reactDom.render)(anchors[i].component, anchors[i].container);
    }
}
...
var TestModule = function (_React$Component) {
    _inherits(TestModule, _React$Component);

    function TestModule(props) {
        _classCallCheck(this, TestModule);

        var _this = _possibleConstructorReturn(this, (TestModule.__proto__ || Object.getPrototypeOf(TestModule)).call(this));
