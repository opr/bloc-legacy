<section class="vertical-cards">
    <h2 class="vertical-cards__heading">Vertical cards section title</h2>
    <div class="vertical-cards__section-container">
        <a href="#" class="vertical-cards__section">
            <div class="vertical-cards__content-container">
                ...
                <div class="vertical-cards__section__content">
                    <h3 class="vertical-cards__section__content__title">Title</h3>
